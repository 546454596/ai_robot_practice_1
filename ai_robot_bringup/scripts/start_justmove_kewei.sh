...
roslaunch ai_robot_bringup start_justmove_kewei.launch paramfile:=${paramfile} agv:=${agv} loc_method:=${loc_method} vision:=${vision} velodyne:=${velodyne} hokuyo:=${hokuyo} quanergy:=${quanergy}
